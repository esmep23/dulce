...
<div data-role="page" id="inicio">
	...
	<script type="text/javascript">
		...
		/*for(i = 0; i < totalFrames; i++) { // loop for each image in sequence
			...
			images[i].src = "frame/barcelona_"+pad(i, 5)+".jpg"; // set the source of the image object
		}*/
		var pic_num = 1;
              var pic_total = 602;
              ...
              function load_img()
              {
                             if(pic_num < pic_total)
                             {
                                           ...
                                           $('.animacion img').css('display','none');

                                           $('.animacion blubi_'+pad(pic_num, 5)).css('display','block');


                                           $('.animacion').append('<img id="video blubi_'+pad(pic_num, 5)+'" src="frame/barcelona_'+pad(pic_num, 5)+'.jpg" alt="" />');
