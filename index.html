...
<head>
	...
	<script src="https://raw.githubusercontent.com/johndyer/mediaelement/master/build/mediaelement-and-player.min.js"></script>
	<link rel="stylesheet" href="https://raw.githubusercontent.com/johndyer/mediaelement/master/build/mediaelementplayer.css" />
...
<div data-role="page" id="inicio">
	...
	<div data-role="content">
		<div id="avanzoRegistro"><a href="#registro"><span>REGISTRARSE</span></a></div>
		<video width="100%" id="maximun" class="maximun" poster="http://barcelonasc.com.ec/apps/bsc_news/video/INTRO.jpg" preload="none" autoplay="true" loop="true">
			<source src="http://www.barcelonasc.com.ec/apps/bsc_news/video/INTRO.mp4" type="video/mp4">
		</video>
		<script type="text/javascript">
			var vid = document.getElementById("#maximun");
//this did the trick 
vid.loop = false;
		 ...
		 $("#cRegistro").validate({
		         rules: {
		          ...
		          messages: {
		            ...
		            phone: "Ingrese un numero de teléfono valido",
		            email: {
...
<div data-role="page" id="principal">
	...
	<div data-role="panel" id="mypanel">
			...
			<ul class="row">	    		
				...
				<li class="col-md-12 col-sm-12 col-xs-12 text-center m20"><a href="https://www.facebook.com/barcelonascweb" data-transition="slide"><i class="fa fa-facebook-official fa-2x"></i><span>Facebook</span></a></li>
				<li class="col-md-12 col-sm-12 col-xs-12 text-center"><a href="https://twitter.com/BarcelonaSCweb" data-transition="slide"><i class="fa fa-twitter-square fa-2x"></i><span>Twitter</span></a></li>
				<li class="col-md-12 col-sm-12 col-xs-12 text-center"><a href="https://instagram.com/barcelonasc" data-transition="slide"><i class="fa fa-instagram fa-2x"></i><span>Instagram</span></a></li>
			</ul>
	...
	<div data-role="content">
		...
		<div class="sliderVideo">
			<div><video width="100%" height="240" poster="http://barcelonasc.com.ec/apps/bsc_news/video/90anios.png" controls>
				  <source src="http://www.barcelonasc.com.ec/apps/bsc_news/video/90_anios_barcelona.mp4" type="video/mp4">
				</video></div>
			<div><video width="100%" height="240" poster="http://barcelonasc.com.ec/apps/bsc_news/video/APP_BSC.png" controls>
				  <source src="http://www.barcelonasc.com.ec/apps/bsc_news/video/APP_BSC.mp4" type="video/mp4">
				</video></div>
		...
		<div id="tabs2">
			...
			<div id="tabs-1A">
				...
				<div class="slider-for">
					<div><img src="https://www.barcelonasc.com.ec/apps/bsc_news/img/thumb3.php?src=./wallpapers/screen1.png&size=300x450" /><div id="desc" onclick="descargo('https://www.barcelonasc.com.ec/apps/bsc_news/img/wallpapers/screen1.png')"><i class="fa fa-silueta-download fa-2x"></i></div></div>
					<div><img src="https://www.barcelonasc.com.ec/apps/bsc_news/img/thumb3.php?src=./wallpapers/screen2.png&size=300x450" /><div id="desc" onclick="descargo('https://www.barcelonasc.com.ec/apps/bsc_news/img/wallpapers/screen2.png')"><i class="fa fa-silueta-download fa-2x"></i></div></div>
					<div><img src="https://www.barcelonasc.com.ec/apps/bsc_news/img/thumb3.php?src=./wallpapers/screen4.jpg&size=300x450" /><div id="desc" onclick="descargo('https://www.barcelonasc.com.ec/apps/bsc_news/img/wallpapers/screen4.jpg')"><i class="fa fa-silueta-download fa-2x"></i></div></div>
					<div><img src="https://www.barcelonasc.com.ec/apps/bsc_news/img/thumb3.php?src=./wallpapers/screen6.jpg&size=300x450" /><div id="desc" onclick="descargo('https://www.barcelonasc.com.ec/apps/bsc_news/img/wallpapers/screen6.jpg')"><i class="fa fa-silueta-download fa-2x"></i></div></div>
				</div>
				<div class="slider-nav">
					...
					<div><img src="https://www.barcelonasc.com.ec/apps/bsc_news/img/thumb3.php?src=./wallpapers/screen4.jpg&size=100x100" alt="" /></div>
					<div><img src="https://www.barcelonasc.com.ec/apps/bsc_news/img/thumb3.php?src=./wallpapers/screen6.jpg&size=100x100" alt="" /></div>
				</div>
			</div>
			<div id="tabs-2A">
				<!--<div class="ads-wallpapers1"></div>-->
