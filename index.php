...
<div data-role="page" id="principal">
	...
	<div data-role="panel" id="mypanel">
			...
			<ul class="row">	    		
				...
				<li class="col-md-12 col-sm-12 col-xs-12 text-center"><a href="#" onclick="window.open('https://play.google.com/store/apps/details?id=air.com.barcelonasc.bscfan', '_system');"><i class="fa fa-bscFan fa-2x"></i><span>BSC FAN</span></a></li>
...
<div data-role="page" id="proximopartido">
	...
	<div data-role="content">
		<div class="ads-proximo1" onclick="window.open('https://play.google.com/store/apps/details?id=air.com.barcelonasc.bscfan', '_system');"></div>
		<div class="cancha-vs">
	...
	<div data-role="footer" data-position="fixed" data-tap-toggle="false" class="footer-bsc">
		<div class="ads-proximo2" onclick="window.open('https://play.google.com/store/apps/details?id=air.com.barcelonasc.bscfan', '_system');"></div>
		<!--<div class="logoMini"></div>-->
	</div><!-- /footer -->
</div><!-- /page -->
...
<div data-role="page" id="distribucion">
	...
	<div data-role="footer" data-position="fixed" data-tap-toggle="false" class="footer-bsc">
		<div class="ads-distribucion1" onclick="window.open('https://play.google.com/store/apps/details?id=air.com.barcelonasc.bscfan', '_system');"></div>
		<!--<div class="logoMini"></div>-->
	</div><!-- /footer -->
</div><!-- /page -->
...
<div data-role="page" id="minuto">
	...
	<div data-role="footer" data-position="fixed" data-tap-toggle="false" class="footer-bsc">
		<div class="ads-minuto1" onclick="window.open('https://play.google.com/store/apps/details?id=air.com.barcelonasc.bscfan', '_system');"></div>
		<!--<div class="logoMini"></div>-->
	</div><!-- /footer -->
</div><!-- /page -->
